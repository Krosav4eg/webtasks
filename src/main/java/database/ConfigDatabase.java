...
public class ConfigDatabase {
	...
	public static void fillTables() throws WebtasksException {
		String st1[] = { "Потапов", "Сергей", "фф-21", "01/09/2011" };
		String st2[] = { "Гринёв", "Юрий", "фф-21", "01/09/2011" };
		String st3[] = { "Артемьев", "Илья", "фф-21", "01/09/2011" };
		String st4[] = { "Подсолнухова", "Юлия", "фф-21", "01/09/2011" };
		String st5[] = { "Емельяненко", "Ирина", "фф-21", "01/09/2011" };
		runStatement(
		...
		String dsp1[] = { "Аналитическая Геометрия" };
		String dsp2[] = { "Программирование" };
		String dsp3[] = { "История Информатики" };
		String dsp4[] = { "Высшая Математика" };
		String dsp5[] = { "Логика" };
		String dsp6[] = { "История Украины" };
		String dsp7[] = { "Базы Данных" };
		String dsp8[] = { "Математический Анализ" };
		String dsp9[] = { "Клиен-Серверные технологии" };
